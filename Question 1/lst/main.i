...
void SYS_Init(void)
{
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 &= ~(0x0F);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 |= (0UL << 0);



    //CLK_SetCoreClock(192000000UL);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL &= (~(1 << 19));
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL &= (~(1 << 16));

  // NF = 8, NR = 1, NO = 1
  // FBDIV[8:0] = 6, INDIV[13:9] = 0, OUTDIV[15:14] = 00
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL &= ~(0xFFFF << 0);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL |= (0x6UL << 0);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL |= (0UL << 9);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL |= (0UL << 14);

  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL &= (~(1 << 18));
  while (!(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->STATUS & 1 << 2));
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 &= ~(0x07 << 0);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 |= (0x02 << 0);
  ...
  // ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) Clock Configuration
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0UL << 24); // ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) HXT clock source
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 |= (0UL << 8); // ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) clock divider 1

  // ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)) Clock Configuration
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 &= ~(0x0FF << 16); // Clear current settings
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKDIV0 |= (7UL << 16); // ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)) clock divider is (7+1) --> ADC clock is PCLK1 = HCLK/2 -> 96/8 = 12 MHz

  // TM1 Clock Selection HXT and Enable Clock Source
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 &= ~(0b111 << 12);
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0UL << 12);

  // Set TM1 Prescale
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL &= ~(0xFF << 0);
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1 << 5); // Timer 3 Clock Enable

  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1UL << 16); // Enable ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) clock
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->AHBCLK |= (1UL << 3); // Enable ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) clock
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1UL << 28); // Enable ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL)) clock
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1UL << 3); // Timer 1 Clock Enable
    ...
    // (0xful << (12)) | (0xful << (16)) |
    // (0xful << (20)) | (0xful << (24)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH |= ((0x02UL<<(4)) | (0x02UL<<(8)) |
    // (0x02UL<<(12)) | (0x02UL<<(16)) |
    // (0x02UL<<(20)) | (0x02UL<<(24)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH &= ~((0xful << 4) | (0xful << 8) | (0xful << 12) |
            (0xful << 16) | (0xful << 20) | (0xful << 24));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPG_MFPH |= ((0x02UL << 4) | (0x02UL << 8) | (0x02UL << 12) |
           (0x02UL << 16) | (0x02UL << 20) | (0x02UL << 24));


    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH &= ~((0xful << (0)) | (0xful << (4)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH |= ((0x02UL<<(0)) | (0x02UL<<(4)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH &= ~((0xful << 0) | (0xful << 4));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH |= (0x02UL << 0) | (0x02UL << 4);


    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH &= ~((0xful << (24)) | (0xful << (28)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH |= ((0x02UL<<(24)) | (0x02UL<<(28)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH &= ~((0xful << 24) | (0xful << 28));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPH |= (0x02UL << 24) | (0x02UL << 28);


    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL &= ~((0xful << (4)) | (0xful << (0)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= ((0x02UL<<(4)) | (0x02UL<<(0)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL &= ~((0xful << 4) | (0xful << 0));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= (0x02UL << 4) | (0x02UL << 0);


    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH &= ~((0xful << (0)) | (0xful << (4)) |
    // (0xful << (8)) | (0xful << (12)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH |= ((0x02UL<<(0)) | (0x02UL<<(4)) |
    // (0x02UL<<(8)) | (0x02UL<<(12)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH &= ~((0xful << 0) | (0xful << 4) | (0xful << 8) | (0xful << 12));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPH |= (0x02UL << 0) | (0x02UL << 4) | (0x02UL << 8) | (0x02UL << 12);


    //GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000008UL) ///< Bit 3 mask of an 32 bit integer, 0x1UL);
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE &= ~(0b11 << 6);
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE |= (0b01 << 6);
    //(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((3)<<2)))) = 1;
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->DOUT |= (1 << 3);



    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL &= ~((0xful << (16)) | (0xful << (20)));
    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= ((0x02UL<<(16)) | (0x02UL<<(20)));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL &= ~((0xful << 16) | (0xful << 20));
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPE_MFPL |= (0x02UL << 16) | (0x02UL << 20);


    //((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPD_MFPH &= ~(0xful << (24));
  ...
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE &= ~((0b11 << 12) | (0b11 << 14));
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE |= (0b01 << 12) | (0b01 << 14);
    //(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(1))) + ((6)<<2)))) = 1;
    //(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(1))) + ((7)<<2)))) = 0;
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->DOUT |= (1 << 6);
...
int32_t main(void)
{
  ...
  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO &= ~(0xful << 16); // FIFO Trigger level is 1 byte


  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD &= ~(0b11 << 28); // Mode 0
  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD &= ~(0xFFFF << 0);
  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD |= 11;
  ...
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= (0x1ul << 1); // Set Data Width to 16-bit
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 |= 0; // Set Bus Mode
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 = (((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->CTL0 & ~((0x7ul << 8) | (0x7ul << 16))) | // Read current CTL0, clear MCLKDIV and TALE fields
  (0x1UL << 8) | // Set MCLK Prescaler
  (0UL << 2) | // Set CS Active Level (0 for active low)
  (0x1UL << 0) | // Enable ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL)) Bank
  (0x3U << 16); // Set TALE for normal timing (extend ALE by 3 MCLK cycles)
  ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0 = 0x03003318U; // Apply to ((EBI_T *) (((uint32_t)0x40000000) + 0x10000UL))->TCTL0
  ...
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE &= ~((0b11 << 12) | (0b11 << 14));
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->MODE |= (0b01 << 12) | (0b01 << 14);
  ...
  ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->CTL &= ~(0x1ul << 8);
    ((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->CTL |= ((0UL << 8) | (0x1ul << 0));
  while (!(((EADC_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x03000UL))->PWRM & (0x1ul << 0))){};
  ...
  Timer1_Init();
    ...
    //LCD_PutString(0, 160, (uint8_t *)"module and it shows X/Y value.", 0xFFE0, 0x0000);
  ...
  while(Timer1_cnt < 5) {};
    ...
    //LCD_PutString(116, 152, (uint8_t *)"*", 0xFFFF, 0x0000);
    //LCD_PutString(168, 304, (uint8_t *)"(120,160)", 0xF800, 0x0000);
   ...
   if (Timer1_flag == 1) {
    ...
    if ((x != 240 // LCD Width at pixels - 1) && (y != 320 // LCD Hight at pixels - 1)) {
     if (!touch_active) { // New touch detected (edge)
      touch_active = 1;
      ((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL))->DOUT &= ~(1 << 7);

      if (draw_mode == 0) {
       if (x < 105 && y < 238 && y > 184) {
        LCD_BlankArea(0, 0, 240 // LCD Width at pixels, 320 // LCD Hight at pixels, 0x0000);
        LCD_DrawCircle(240 / 2, 320 / 2, 50, 0x001F, 1);
        draw_mode = 1;
       }
       else if (x < 105 && y < 142 && y > 88) {
        LCD_BlankArea(0, 0, 240 // LCD Width at pixels, 320 // LCD Hight at pixels, 0xF800);
        LCD_DrawFilledStar(240 / 2, 320 / 2, 75, 0xFFE0);
        draw_mode = 1;
       }
        ...
        LCD_BlankArea(0, 0, 240 // LCD Width at pixels, 320 // LCD Hight at pixels, 0x0000);
        LCD_DrawRectangle((240/2) - (200/2), (320/2) - (150/2), 200, 125, 0xF800, 1);
        draw_mode = 1;
       }
       else {
        LCD_DrawRGBImage(image);
