...
void SYS_Init(void)
{
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->PLLCTL &= ~(0xFFFF << 0); // Clear PLLCTL
  ...
  while (!(((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->STATUS & 1 << 2)); // Wait for PLL to stabilize
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 &= ~(0x07 << 0); // Clear PLL output
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL0 |= (0x02 << 0); // Select PLLOUT -> HCLK
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 &= ~(0b111 << 12); // Clear TM1 clock selection
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0UL << 12); // Set TM1 clock source HXT


  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL &= ~(0xFF << 0); // Set TM1 prescale 1
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->APBCLK0 |= (1UL << 3); // Enable TM1 clock
